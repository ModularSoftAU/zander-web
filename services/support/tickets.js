...
// status all still live in this module; category + user data access are their
// own sibling modules. controllers/supportTicketController.js is now a thin
// barrel that `export *`s this module plus categories.js and users.js, so every
// existing `.../supportTicketController.js` import site is unchanged.
import {
