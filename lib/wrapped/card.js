 ...
 * @param {{ logoDataUri?: string|null, avatarDataUri?: string|null }} [assets]
...
export function renderWrappedCard(payload, assets = {}) {
  ...
  const { logoDataUri = null, avatarDataUri = null } = assets;
  ...
  if (s.tenure?.firstSeen) push("First joined", dmy(s.tenure.firstSeen));
