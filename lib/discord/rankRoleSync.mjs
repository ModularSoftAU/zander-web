...
/**
 * Lowercases a uuid for comparison against the `userRanks` cross-database
 * view, whose `uuid` column passes `luckperms_user_permissions.uuid` through
 * unchanged — LuckPerms' MySQL storage uses standard dashed VARCHAR(36)
 * uuids (see services/profileService.js:getUserRanks), matching
 * `users.uuid`'s own dashed format. No dash-stripping needed here.
 */
